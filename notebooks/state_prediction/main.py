...
batch1 = lyriks[metadata_lyriks.extraction_date == '4/9/24']
...
model = MLP(input_dim=input_dim, hidden_dim=8, n_classes=2)
...
print(pd.DataFrame(cm_raw, index=labels0, columns=labels1))
print()
